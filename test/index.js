...
module.exports.total = function (test) {
  ...
  console.log('pobreza', total.valorCombatePobreza())
  console.log('icms rem', total.valorIcmsUfRemetente())
  console.log('icms dest', total.valorIcmsUfDestinatario())
  
  test.equal(total.valorCombatePobreza(), '1.23')
  test.equal(total.valorIcmsUfRemetente(), '900.99')
  test.equal(total.valorIcmsUfDestinatario(), '77.77')
